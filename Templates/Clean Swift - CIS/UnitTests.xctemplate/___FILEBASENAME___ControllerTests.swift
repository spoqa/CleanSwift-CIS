...
class ___VARIABLE_productName___ControllerTests: XCTestCase {
    ...
    override func setUp() {
        ...
        self.controller = ___VARIABLE_productName___Controller(interactor: self.mockInteractor, store: self.mockStore)
    }
...
extension ___VARIABLE_productName___ControllerTests {

    class MockInteractor: ___VARIABLE_productName___Interactable {
    ...
    class MockStore: ___VARIABLE_productName___Mutatable {
